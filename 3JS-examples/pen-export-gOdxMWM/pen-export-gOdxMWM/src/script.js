...
let sphere = new THREE.Mesh(new THREE.SphereGeometry(0.1), new THREE.MeshLambertMaterial({color: "red"}));
let pin = new THREE.Mesh(new THREE.ConeGeometry(0.1, 0.5).translate(0, -0.3, 0).rotateX(Math.PI * 0.5), new THREE.MeshLambertMaterial({color: "blue"}));
[
  [0, 0],
  [0, 45],
  [45, 0],
