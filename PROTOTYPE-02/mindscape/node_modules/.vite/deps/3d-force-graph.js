...
function link_default(links) {
  var id = index, strength = defaultStrength, strengths, distance = constant_default(30), distances, nodes, nDim, count2, bias, random, iterations = 1;
  if (links == null)
    links = [];
...
function ordinal() {
  var index6 = new InternMap(), domain = [], range2 = [], unknown = implicit;
  function scale(d) {
    let i = index6.get(d);
    if (i === void 0) {
      if (unknown !== implicit)
